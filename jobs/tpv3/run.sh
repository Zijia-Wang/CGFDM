...
#nsys profile --trace=mpi,cuda,osrt,nvtx --mpi-impl=openmpi -f true -o dynfd_profile10 $RUN -np $NP -x LD_LIBRARY_PATH --machinefile nodelists ${EXE}
#nsys stats dynfd_profile10.qdrep | tee profile.log
